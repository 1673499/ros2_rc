...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(os.path.join(get_package_share_directory('smart_car'), 'launch', 'rviz_.launch.py')),
            launch_arguments={
                'namespace': '',
                'use_namespace': 'false',
                'use_sim_time': 'true',
        ...
        IncludeLaunchDescription(
            ...
            launch_arguments={
                ...
                'use_namespace': 'False',
                'slam': 'False',
                'map':'/home/ros2/ros2_rc/src/smart_car/map/smalltown_world.yaml',
                'use_sim_time': 'true',
